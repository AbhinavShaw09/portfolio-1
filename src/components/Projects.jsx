            ...
            <section class="text-white body-font">
                <div class="container px-5 mx-auto">
                    <div class="flex flex-col text-center w-full mb-20">
                        <h1 class="sm:text-3xl text-2xl font-medium title-font mb-4 white">Projects</h1>
                        <p class="lg:w-2/3 mx-auto leading-relaxed text-base">Some of the cool stuff that i have built 🔨.</p>
                    </div>
